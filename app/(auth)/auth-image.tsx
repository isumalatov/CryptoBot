...
export default function AuthImage() {
  return (
    <div className="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
      ...
      <Image className="absolute top-5 left-0 -translate-x-1/2 ml-8 hidden lg:block" src={AuthDecoration} priority width={218} height={224} alt="Authentication decoration" />
    </div>
  )
}
